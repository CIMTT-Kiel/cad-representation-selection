...
\address[c]{Christian-Albrechts-Universität zu Kiel, Christian-Albrechts-Platz 4, 24118 Kiel, Germany}
...
\begin{figure*}[h] 
\centerline{\includegraphics[width=0.9\textwidth]{classification_metrics_plot.png}}
...
\centerline{\includegraphics[width=0.9\textwidth]{confusion_matrix_trees.png}}
...
\begin{figure*}[h]
\centerline{\includegraphics[width=0.9\textwidth]{confusion_matrix_images.png}}
...
\begin{figure*}[h]
\centerline{\includegraphics[width=0.9\textwidth]{confusion_matrix_invariants.png}}
...
\begin{figure*}[h]
\centerline{\includegraphics[width=0.9\textwidth]{confusion_matrix_vecsets.png}}
...
\begin{figure*}[t]
\centerline{\includegraphics[width=0.9\textwidth]{confusion_matrix_voxels.png}}
...
\centerline{\includegraphics[width=0.9\textwidth]{error_distributions.png}}
...
\begin{figure*}[t]\vspace*{4pt}
\centerline{\includegraphics[width=0.9\textwidth]{regression_metrics_mae_plot.png}}
...
\begin{figure*}[t]\vspace*{4pt}
\centerline{\includegraphics[width=0.9\textwidth]{regression_metrics_mse_plot.png}}
...
\begin{figure*}[t]\vspace*{4pt}
\centerline{\includegraphics[width=0.9\textwidth]{regression_metrics_r2_plot.png}}
