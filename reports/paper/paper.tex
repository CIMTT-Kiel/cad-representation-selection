...
The \mbox{invariant-based} approach attains slightly lower medians, but with substantially heavier tails. Its mean relative errors exceed those of the \mbox{tree-based} approach by roughly a factor of seven. The \mbox{tree-based} approach therefore remains the most reliable across all regression targets.
...
%  TODO: Die Werte in der Tabelle sind noch Platzhalter bzw. die Ergebnisse aus der Evaluation mit dem Leak - die finalen Ergebnisse muessen noch nachgetragen werden und ggf auch die Besten Werte nochmal überprueft werden. Sollten Werte stark abweichen bitte unbedingt nochmal die Argumentation im Text prüfen. 
...
\midrule
\multirow{7}{*}{Volume}
 & Voxels                & $3.99\cdot10^{5}$          & $1.11\cdot10^{13}$          & 0.068            & 0.80            & 5.13 \\
 & Vecsets               & $3.36\cdot10^{5}$          & $9.31\cdot10^{12}$          & 0.217            & 0.66            & 10.12 \\
 & Trees                 & $2.20\cdot10^{5}$          & $3.23\cdot10^{12}$          & 0.728            & $\mathbf{0.23}$ & $\mathbf{0.32}$ \\
 & Invariants            & $\mathbf{1.83\cdot10^{5}}$ & $\mathbf{1.05\cdot10^{12}}$ & $\mathbf{0.912}$ & 0.64            & 653.85 \\
\cmidrule(l){2-7}
...
\midrule
\multirow{7}{*}{Faces}
 & Voxels                & 9.6            & $1.65\cdot10^{3}$ & 0.442            & 0.16            & 0.33 \\
 & Vecsets               & 3.1            & 149.5             & 0.949            & 0.04            & 0.13 \\
 & Trees                 & $\mathbf{2.3}$ & $\mathbf{89.5}$   & $\mathbf{0.970}$ & 0.06            & $\mathbf{0.05}$ \\
 & Invariants            & 4.6            & 428.6             & 0.855            & $\mathbf{0.03}$ & 0.38 \\
\cmidrule(l){2-7}
...
\midrule
\multirow{7}{*}{Edges}
 & Voxels                & 33.6           & $2.26\cdot10^{4}$          & 0.145            & 0.35            & 0.56 \\
 & Vecsets               & 9.4            & $1.39\cdot10^{3}$          & 0.947            & 0.05            & 0.14 \\
 & Trees                 & $\mathbf{7.8}$ & $\mathbf{1.03\cdot10^{3}}$ & $\mathbf{0.961}$ & 0.07            & $\mathbf{0.07}$ \\
 & Invariants            & 13.6           & $3.65\cdot10^{3}$          & 0.862            & $\mathbf{0.04}$ & 0.47 \\
\cmidrule(l){2-7}
...
\midrule
\multirow{7}{*}{Vertices}
 & Voxels                & 20.6           & $7.01\cdot10^{3}$ & 0.403            & 0.20            & 0.46 \\
 & Vecsets               & 6.4            & 661.6             & 0.944            & 0.05            & 0.15 \\
 & Trees                 & $\mathbf{5.1}$ & $\mathbf{437.6}$  & $\mathbf{0.963}$ & 0.07            & $\mathbf{0.06}$ \\
 & Invariants            & 9.0            & $1.58\cdot10^{3}$ & 0.866            & $\mathbf{0.04}$ & 0.48 \\
\cmidrule(l){2-7}
