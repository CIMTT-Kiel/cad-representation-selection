...
The results show that the combination of tree-structured STEP file representations and a Child-Sum Tree-LSTM model, as proposed by Miles~\cite{miles2023recursive}, achieved the best performance across all evaluated tasks.
