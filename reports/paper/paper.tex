...
\begin{itemize}
    \item Comparison of five different CAD model representation forms, including dimensionless invariants, trees extracted from B-Rep models (here applied to STEP files), multi-view images and vector sets.
...
Stratified sampling was used to ensure that the class distribution was consistent across all splits.
...
\begin{figure*}[h] 
\centerline{\includegraphics[width=0.9\textwidth]{classification_metrics_plot.pdf}}
...
\begin{figure*}[h]
\centerline{\includegraphics[width=0.9\textwidth]{clf_stability.png}}
...
\centerline{\includegraphics[width=0.9\textwidth]{confusion_matrix_trees.pdf}}
...
\begin{figure*}[h]
\centerline{\includegraphics[width=0.9\textwidth]{confusion_matrix_images.pdf}}
...
\begin{figure*}[h]
\centerline{\includegraphics[width=0.9\textwidth]{confusion_matrix_invariants.pdf}}
...
\begin{figure*}[h]
\centerline{\includegraphics[width=0.9\textwidth]{confusion_matrix_vecsets.pdf}}
...
\begin{figure*}[t]
\centerline{\includegraphics[width=0.9\textwidth]{confusion_matrix_voxels.pdf}}
...
\centerline{\includegraphics[width=0.9\textwidth]{error_distributions.pdf}}
...
\begin{figure*}[t]\vspace*{4pt}
\centerline{\includegraphics[width=0.9\textwidth]{regression_metrics_mae_plot.pdf}}
...
\begin{figure*}[t]\vspace*{4pt}
\centerline{\includegraphics[width=0.9\textwidth]{regression_metrics_mse_plot.pdf}}
...
\begin{figure*}[t]\vspace*{4pt}
\centerline{\includegraphics[width=0.9\textwidth]{regression_metrics_r2_plot.pdf}}
