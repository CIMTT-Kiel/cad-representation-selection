...
Convolutional neural networks (CNNs) are a class of \mbox{machine-learning} architectures widely employed in \mbox{image-processing} tasks.
...
In contrast to YOLO, which operates on a single input image, multi-view architectures such as RotationNet process multiple images to produce a single prediction~\cite{kanezaki2018rotationnet}.
